inherited frm_ConsultaVenda: Tfrm_ConsultaVenda
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ClientHeight = 553
  ...
  inherited Panel3: TPanel
    ...
    object Label55: TLabel [7]
      Left = 661
      Top = 20
      Width = 95
      Height = 13
      Caption = 'impar formul'#225'rio'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object Label7: TLabel [10]
      ...
      Width = 261
      Height = 13
      Caption = 'F7-> Alternar entre tipos de busca por vendas'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object Label19: TLabel [11]
      ...
      Width = 220
      Height = 13
      Caption = 'F2-> Alternar foco entre filtros e grade'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object Panel1: TPanel [5]
    ...
    object Label17: TLabel
      ...
      Width = 135
      Height = 13
      Caption = 'campos com * s'#227'o opcionais'
    ...
    object pnLocal1: TPanel
      ...
      object edtVend: TMaskEdit
        ...
        OnEnter = edtmaskeditformulario1Enter
        OnExit = edtmaskeditformulario1Exit
        OnKeyDown = edtVendKeyDown
      end
      object edtDataVend: TMaskEdit
        Left = 108
        Top = 17
        Width = 117
        Height = 21
        ...
        TabOrder = 1
        Text = '  /  /    '
        OnEnter = edtmaskeditformulario1DblClick
        OnExit = edtmaskeditformulario1Exit
        OnKeyDown = edtDataVendKeyDown
      end
    end
    ...
    object grade1: TDBGrid
      ...
      Cursor = crHandPoint
      Hint = 
        'Duplo clique exibe os vendedores participantes da venda, caso ex' +
        'iste mais de um'
      DataSource = ds1
      ...
      Font.Name = 'MS Sans Serif'
      Font.Style = [fsBold]
      Options = [dgTitles, dgIndicator, dgRowLines, dgTabs, dgRowSelect, dgCancelOnExit]
      ParentFont = False
    ...
    object grade2: TDBGrid
      ...
      Height = 203
      Cursor = crHandPoint
      Hint = 'Duplo clique - exibe informa'#231#245'es sobre o pagamento'
      DataSource = ds2
      FixedColor = clTeal
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
  ...
  object ds1: TDataSource
    DataSet = DMVendas.qVendas
    Left = 13
    Top = 173
  end
  object ds2: TDataSource
    DataSet = DMVendas.qFormas
    Left = 541
    Top = 169
  end
  object ds3: TDataSource
    DataSet = DMVendas.qItensVenda
    Left = 5
    Top = 334
  end
end
