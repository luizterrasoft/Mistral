object frm_FechamentoVenda_Cartao: Tfrm_FechamentoVenda_Cartao
  Left = 110
  Top = 56
  ...
  object Label12: TLabel
    ...
    Width = 363
    Height = 23
    Caption = '[Dados relativos ao cart'#227'o de cr'#233'dito]'
  ...
  object edtParcela: TMaskEdit
    ...
    TabOrder = 7
    Text = '  '
    OnChange = edtParcelaChange
    OnEnter = edtParcelaEnter
    OnKeyDown = edtParcelaKeyDown
  end
  object pnValorMinimo: TPanel
    Left = 390
    Top = 48
    Width = 187
    Height = 24
  ...
  object pnTotalFinanciado: TPanel
    Left = 104
    Top = 168
    Width = 132
    Height = 31
