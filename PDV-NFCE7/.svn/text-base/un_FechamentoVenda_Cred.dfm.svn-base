object frm_FechamentoVenda_Cred: Tfrm_FechamentoVenda_Cred
  Left = 121
  Top = 53
  ...
  object Label12: TLabel
    ...
    Width = 389
    Height = 23
    Caption = '[Dados relativos '#224' concess'#227'o de cr'#233'dito]'
  ...
  object pnValoresJaInformados: TPanel
    Left = 505
    Top = 80
    Width = 345
    Height = 81
    ...
    object LabelOO1: TLabelOO
      ...
      Width = 229
      Height = 13
      Caption = 'Valores j'#225' informados para a ENTRADA:'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object lista: TListBox
      ...
      Height = 59
      Cursor = crHandPoint
      Hint = 'DUPLO CLIQUE - Seleciona valor desejado'
      Color = clTeal
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -15
  ...
  object edtNumBoleta: TMaskEdit
    ...
    Text = '      '
    Visible = False
    OnExit = edtNumBoletaExit
    OnKeyDown = edtNumBoletaKeyDown
  end
