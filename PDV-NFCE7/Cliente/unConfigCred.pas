...
var
  frm_configCred: Tfrm_configCred;
...
procedure Tfrm_configCred.btnCancelClick(Sender: TObject);
begin
  close;
end;

{Botao de Ok para atualizacao ***}
procedure Tfrm_configCred.btnOkClick(Sender: TObject);
begin
  ...
  frm_principal.x_pathsystem_caixa := Trim(edtPath.text);
  ...
  DeleteFile ('c:\nativa\cred.ini');
  frm_principal.GravaConfig;
  close;
end;

procedure Tfrm_configCred.FormActivate(Sender: TObject);
begin
  ...
  edtPath.text := frm_principal.x_pathsystem_caixa;
...
procedure Tfrm_configCred.edtLocalPgtoEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtObs1Enter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtObs2Enter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.e(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrm_configCred.edtObs1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) or (key=K_BAIXO) then
    edtObs2.setfocus;
...
procedure Tfrm_configCred.edtObs2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) then
    btnOk.click;
...
procedure Tfrm_configCred.edtLocalPgtoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) or (key=K_BAIXO) then
    edtObs1.setfocus;
...
procedure Tfrm_configCred.chQualquerLojaClick(Sender: TObject);
begin
  if (not chQualquerLoja.checked) then
    habilitaedit(edtLocalPgto)
  else
...
procedure Tfrm_configCred.chQualquerLojaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (not chQualquerLoja.checked) then
    habilitaedit(edtLocalPgto)
...
procedure Tfrm_configCred.edtSPCEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtLojaFrenteEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtSPCKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) or (key=K_BAIXO) then
    edtLimCred.setfocus;
...
procedure Tfrm_configCred.edtLojaFrenteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) then
    btnOk.click;
...
procedure Tfrm_configCred.edtLojaFrenteDblClick(Sender: TObject);
begin
  with (frm_f8Lojas) do
  begin
    left:=287;
...
procedure Tfrm_configCred.edtLimCredKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) or (key=K_BAIXO) then
...
procedure Tfrm_configCred.edtLimCredEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtEndeEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ESC) then
    btnCancel.click;
...
procedure Tfrm_configCred.btnProcurarClick(Sender: TObject);
begin
  if (OpenDialog1.Execute) then
    edtArquivoProposta.text:=OpenDialog1.filename;
end;

procedure Tfrm_configCred.btnProcurarWordClick(Sender: TObject);
begin
  if (OpenDialog1.Execute) then
    edtWinWord.text:=OpenDialog1.filename;
end;

procedure Tfrm_configCred.edtArquivoPropostaEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtArquivoPropostaKeyDown(Sender: TObject;
...
procedure Tfrm_configCred.edtWinWordEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtPathEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtWinWordKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrm_configCred.edtPathKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=13) or (key=40) then
...
procedure Tfrm_configCred.edtHostFtpEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtHostFtpKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) or (key=K_BAIXO) then
    edtUserId.setfocus;
...
procedure Tfrm_configCred.edtUseridEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtSenhaEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtUseridKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) or (key=K_BAIXO) then
    edtSenha.setfocus;
...
procedure Tfrm_configCred.edtSenhaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=K_ENTER) then
    btnOk.click;
...
procedure Tfrm_configCred.edtEspacoEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_configCred.edtPathImagemKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key=13) then
    btnOk.click;
...
procedure Tfrm_configCred.edtPathImagemEnter(Sender: TObject);
begin
