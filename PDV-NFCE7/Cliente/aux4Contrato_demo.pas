...
type
  Tfrm_Aux4Contrato_demo = class(TForm)
    Label1: TLabel;
    Bevel1: TBevel;
    edtCpf: TMaskEdit;
...
var
  frm_Aux4Contrato_demo: Tfrm_Aux4Contrato_demo;
...
procedure Tfrm_Aux4Contrato_demo.edtCpfEnter(Sender: TObject);
begin
  edtCpf.selectall;
end;

procedure Tfrm_Aux4Contrato_demo.edtCpfKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
