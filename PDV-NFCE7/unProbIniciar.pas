...
begin
  ...
  vMailItem.Recipients.Add('suporte@mistralsistemas.com.br'); // 1o destinatário
  vMailItem.Recipients.Add('vinicius@mistralsistemas.com'); // 2o destinatário
  vMailItem.Recipients.Add('armando@mistralsistemas.com'); // 3o destinatário
  self.refresh;
  with TQuery.create(Application) do
    try
      ...
      try
        ...
        vMailItem.Subject := 'Erro de Conexão '+Application.Title;
        ;
      end;
    finally
      destroy;
