object frm_FechamentoVenda_ValeMerc: Tfrm_FechamentoVenda_ValeMerc
  Left = 105
  Top = 121
  ...
  object Label12: TLabel
    ...
    Width = 354
    Height = 23
    Caption = '[Dados relativos ao Vale Mercadoria]'
  ...
  object edtNParc: TMaskEdit
    ...
    TabOrder = 2
    Text = '  '
    OnEnter = edtNParcEnter
    OnKeyDown = edtNParcKeyDown
  end
  ...
  object edtCodFunc: TMaskEdit
    ...
    TabOrder = 4
    Text = '        '
    OnDblClick = edtCodFuncDblClick
    OnEnter = edtCodFuncEnter
    OnExit = edtCodFuncExit
    OnKeyDown = edtCodFuncKeyDown
  end
  object pnFunc: TPanelOO
    Left = 148
    Top = 112
    Width = 417
    Height = 27
