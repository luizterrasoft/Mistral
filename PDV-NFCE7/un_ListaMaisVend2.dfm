inherited frm_ListaMaisVend2: Tfrm_ListaMaisVend2
  Left = 141
  Top = 9
  ClientHeight = 511
  ClientWidth = 501
  ...
  object LabelOO3: TLabelOO [1]
    Left = 14
    Top = 42
    Width = 97
    Height = 13
    Caption = 'Data das vendas'
  ...
  object LabelOO7: TLabelOO [4]
    Left = 14
    Top = 119
    Width = 118
    Height = 13
    Caption = 'Grupos dos produtos'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object LabelOO10: TLabelOO [5]
    Left = 14
    Top = 157
    Width = 138
    Height = 13
    Caption = 'Subgrupos dos produtos'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  inherited Panel3: TPanel
    ...
    inherited Label5: TLabel
      ...
      Top = 7
      Width = 211
      Caption = 'Listar produtos mais vendidos na loja'
    end
    ...
    inherited Panel4: TPanel
      ...
      inherited botao1: TButton
        Top = 60
        Width = 73
        Caption = 'Imprimir relat'#243'rio - [F5]'
      end
      object btnConfere: TPanel
        Left = 16
        Top = 2
        Width = 249
        Height = 23
        ...
        Caption = 'Listar produtos mais vendidos - F5'
        Color = clTeal
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -13
  ...
  object edtData1: TMaskEditOO [18]
    Left = 14
    Top = 57
    Width = 80
    Height = 21
    ...
    zNomeOO = 'Data inicial das vendas'
    zFieldTypeOO = ftDateTime
    zFieldLengthOO = 10
    zTipoOO = -1
    zEntidadeOO = 'VENDAS'
    zLabelEntidadeOO = 'Venda'
    zTipoPesquisaF8 = False
    zMensagemF1 = 'Data inicial das vendas - formato 99/99/9999'
  end
  object edtData2: TMaskEditOO [19]
    Left = 112
    Top = 57
    Width = 80
    Height = 21
    ...
    zNomeOO = 'Data final das vendas'
    zFieldTypeOO = ftDateTime
    zFieldLengthOO = 10
    zTipoOO = -1
    zEntidadeOO = 'VENDAS'
    zLabelEntidadeOO = 'Vendas'
    zTipoPesquisaF8 = True
    zMensagemF1 = 'Data final das vendas - formato 99/99/9999'
  end
  object chDataPedido: TCheckBoxOO [20]
    Left = 199
    Top = 61
    Width = 60
    Height = 17
    ...
    ParentFont = False
    TabOrder = 22
    OnClick = chDataPedidoClick
    OnKeyDown = chDataPedidoKeyDown
    zEdit1MarcaOO = edtData1
    zEdit2MarcaOO = edtData2
    zEditFocusOO = edtLoja1
  end
  object edtLoja1: TMaskEditOO [21]
    Left = 14
    Top = 95
    Width = 80
    Height = 21
    ...
    zNomeOO = 'Referencia Inicial'
    zFieldTypeOO = ftString
    zFieldLengthOO = 15
    zTipoOO = -1
    zEntidadeOO = 'PRODUTOS'
    zLabelEntidadeOO = 'Referencia Interna'
    zPainelEntidadeOO = pnLoja1
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial da loja: formato 99 - <F8/Duplo clique exibe loja' +
      's cadastradas>'
  end
  object edtLoja2: TMaskEditOO [22]
    Left = 218
    Top = 95
    Width = 81
    Height = 21
    ...
    zNomeOO = 'Referencia Final'
    zFieldTypeOO = ftString
    zFieldLengthOO = 15
    zTipoOO = -1
    zEntidadeOO = 'PRODUTOS'
    zLabelEntidadeOO = 'lojas'
    zPainelEntidadeOO = pnLoja2
    zTipoPesquisaF8 = True
    zMensagemF1 = 'C'#243'digo final da referencia'
  end
  object pnLoja2: TPanelOO [23]
    Left = 300
    Top = 95
    Width = 132
    Height = 20
  ...
  object chLoja: TCheckBoxOO [25]
    ...
    TabOrder = 25
    OnClick = chLojaClick
    OnKeyDown = chLojaKeyDown
    zEdit1MarcaOO = edtLoja1
    zEdit2MarcaOO = edtLoja2
    zEditFocusOO = edtGrupo1
  end
  object edtGrupo1: TMaskEditOO [26]
    Left = 14
    Top = 134
    Width = 53
    Height = 21
    ...
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtmaskeditformulario1Exit
    OnKeyDown = Grupo1KeyDown
    zNomeOO = 'Grupo inicial'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 2
    zTipoOO = -1
    zEntidadeOO = 'GRUPOS_PRODUTOS'
    zLabelEntidadeOO = 'grupos de produtos'
    zPainelEntidadeOO = pnGrupo1
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial dos grupos: formato 99 - <F8/Duplo clique exibe g' +
      'rupos cadastrados>'
  end
  object pnGrupo1: TPanelOO [27]
    Left = 68
    Top = 134
    Width = 156
    Height = 21
  ...
  object chGrupo: TCheckBoxOO [29]
    ...
    ParentFont = False
    TabOrder = 28
    OnClick = chGrupoClick
    OnKeyDown = chGrupoKeyDown
    zEdit1MarcaOO = edtGrupo1
    zEdit2MarcaOO = edtGrupo2
    zEditFocusOO = edtSubgrupo1
  end
  object edtSubgrupo1: TMaskEditOO [30]
    Left = 14
    Top = 173
    Width = 53
    Height = 21
    ...
    OnDblClick = edtmaskeditformulario1DblClick
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtSubgrupo1Exit
    OnKeyDown = edtSubgrupo2KeyDown
    zNomeOO = 'Subgrupo inicial'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 2
    zTipoOO = -1
    zEntidadeOO = 'SUBGRUPOS_PRODUTOS'
    zLabelEntidadeOO = 'SubGrupos dos Produtos'
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial dos subgrupos: formato 99 - <F8/Duplo clique exib' +
      'e subgrupos cadastrados>'
  end
  object chSubgrupo: TCheckBoxOO [31]
    Left = 437
    Top = 175
    Width = 57
    Height = 17
    ...
    ParentFont = False
    TabOrder = 29
    OnClick = chSubgrupoClick
    OnKeyDown = chSubgrupoKeyDown
    zEdit1MarcaOO = edtSubgrupo1
    zEdit2MarcaOO = edtSubgrupo2
    zEditFocusOO = edtForn1
  end
  object edtForn1: TMaskEditOO [32]
    Left = 14
    Top = 210
    Width = 53
    Height = 21
    ...
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtmaskeditformulario1Exit
    OnKeyDown = edtForn1KeyDown
    zNomeOO = 'Fornecedor inicial'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 6
    zTipoOO = -1
    zEntidadeOO = 'FORNECEDORES'
    zLabelEntidadeOO = 'fornecedores'
    zPainelEntidadeOO = pnForn1
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial do fornecedor: formato 999999 - <F8/Duplo clique ' +
      'exibe fornecedores cadastrados>'
  end
  object pnForn1: TPanelOO [33]
    Left = 68
    Top = 210
    Width = 364
    Height = 21
  ...
  object chForn: TCheckBoxOO [35]
    ...
    TabOrder = 32
    OnClick = chFornClick
    OnKeyDown = chFornKeyDown
    zEdit1MarcaOO = edtForn1
    zEdit2MarcaOO = edtForn2
    zEditFocusOO = edtColecao1
  end
  object edtColecao1: TMaskEditOO [36]
    Left = 14
    Top = 269
    Width = 53
    Height = 21
    ...
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtmaskeditformulario1Exit
    OnKeyDown = edtColecao1KeyDown
    zNomeOO = 'Cole'#231#227'o inicial'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 4
    zTipoOO = -1
    zEntidadeOO = 'COLECOES'
    zLabelEntidadeOO = 'colecoes'
    zPainelEntidadeOO = pnColecao1
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial da cole'#231#227'o: formato 9999 - <F8/Duplo clique exibe' +
      ' colecoes cadastradas>'
  end
  object pnColecao1: TPanelOO [37]
    Left = 68
    Top = 269
    Width = 156
    Height = 21
  ...
  object chColecao: TCheckBoxOO [39]
    Left = 437
    Top = 272
    Width = 58
    Height = 17
    ...
    ParentFont = False
    TabOrder = 35
    OnClick = chColecaoClick
    OnKeyDown = chColecaoKeyDown
    zEdit1MarcaOO = edtColecao1
    zEdit2MarcaOO = edtColecao2
    zEditFocusOO = edtLinha1
  end
  object edtLinha2: TMaskEditOO [40]
    Left = 228
    Top = 305
    Width = 53
    Height = 21
    ...
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtmaskeditformulario1Exit
    OnKeyDown = edtLinha2KeyDown
    zNomeOO = 'Linha final'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 4
    zTipoOO = -1
    zEntidadeOO = 'LINHAS'
    zLabelEntidadeOO = 'linhas'
    zPainelEntidadeOO = pnLinha2
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo final da linha: formato 99 - <F8/Duplo clique exibe linha' +
      's cadastradas>'
  end
  object edtLinha1: TMaskEditOO [41]
    Left = 14
    Top = 306
    Width = 53
    Height = 21
    ...
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtmaskeditformulario1Exit
    OnKeyDown = edtLinha1KeyDown
    zNomeOO = 'Linha inicial'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 4
    zTipoOO = -1
    zEntidadeOO = 'LINHAS'
    zLabelEntidadeOO = 'linhas'
    zPainelEntidadeOO = pnLinha1
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial da linha: formato 9999 - <F8/Duplo clique exibe l' +
      'inhas cadastradas>'
  end
  object pnLinha1: TPanelOO [42]
    Left = 68
    Top = 306
    Width = 156
    Height = 21
  ...
  object chLinha: TCheckBoxOO [44]
    ...
    ParentFont = False
    TabOrder = 38
    OnClick = chLinhaClick
    OnKeyDown = chLinhaKeyDown
    zEdit1MarcaOO = edtLinha1
    zEdit2MarcaOO = edtLinha2
    zEditFocusOO = edtVend1
  end
  object edtGrupo2: TMaskEditOO [45]
    Left = 228
    Top = 134
    Width = 53
    Height = 21
    ...
    zEntidadeOO = 'GRUPOS_PRODUTOS'
    zLabelEntidadeOO = 'grupos de produtos'
    zPainelEntidadeOO = pnGrupo2
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo final dos grupos: formato 99 - <F8/Duplo clique exibe gru' +
      'pos cadastrados>'
  end
  object edtSubgrupo2: TMaskEditOO [46]
    Left = 228
    Top = 173
    Width = 53
    Height = 21
    ...
    OnDblClick = edtmaskeditformulario1DblClick
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtSubgrupo2Exit
    OnKeyDown = edtSubgrupo2KeyDown
    zNomeOO = 'Subgrupo final'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 2
    zTipoOO = -1
    zEntidadeOO = 'SUBGRUPOS_PRODUTOS'
    ...
    zTipoPesquisaF8 = False
    zMensagemF1 = 
      'C'#243'digo final dos subgrupos: formato 99 - <F8/Duplo clique exibe ' +
      'subgrupos cadastrados>'
  end
  object edtForn2: TMaskEditOO [47]
    Left = 14
    Top = 232
    Width = 53
    Height = 21
    ...
    zNomeOO = 'Fornecedor final'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 6
    zTipoOO = -1
    zEntidadeOO = 'FORNECEDORES'
    zLabelEntidadeOO = 'fornecedores'
    zPainelEntidadeOO = pnForn2
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo final do fornecedor: formato 999999 - <F8/Duplo clique ex' +
      'ibe fornecedores cadastrados>'
  end
  object edtColecao2: TMaskEditOO [48]
    Left = 228
    Top = 269
    Width = 53
    Height = 21
    ...
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtmaskeditformulario1Exit
    OnKeyDown = edtColecao2KeyDown
    zNomeOO = 'Cole'#231#227'o final'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 4
    zTipoOO = -1
    zEntidadeOO = 'COLECOES'
    zLabelEntidadeOO = 'colecoes'
    zPainelEntidadeOO = pnColecao2
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo final da cole'#231#227'o: formato 9999 - <F8/Duplo clique exibe c' +
      'olecoes cadastradas>'
  end
  object edtQtde: TMaskEditOO [49]
    Left = 14
    Top = 390
    Width = 53
    Height = 21
    ...
    zNomeOO = 'Qtde de produtos'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 4
    zTipoOO = -1
    zEntidadeOO = 'QUANTIDADE'
    zLabelEntidadeOO = 'qtde de produtos'
    zTipoPesquisaF8 = False
    zMensagemF1 = 'Qtde de produtos analisados - formato: 9999 '
  end
  object rdOrdem: TRadioGroup [50]
    Left = 193
    Top = 376
    Width = 240
    Height = 34
  ...
  object edtVend1: TMaskEditOO [51]
    Left = 14
    Top = 346
    Width = 53
    Height = 21
    ...
    ParentFont = False
    TabOrder = 14
    OnDblClick = edtVend1DblClick
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtVend1Exit
    OnKeyDown = edtVend1KeyDown
    zNomeOO = 'Vendedor inicial'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 6
    zTipoOO = -1
    zEntidadeOO = 'VENDEDORES'
    zLabelEntidadeOO = 'vendedores'
    zPainelEntidadeOO = PnVendedor1
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo inicial do vendedor: formato 999999 - <F8/Duplo clique ex' +
      'ibe fornecedores cadastrados>'
  end
  object edtVend2: TMaskEditOO [52]
    Left = 228
    Top = 346
    Width = 53
    Height = 21
    ...
    ParentFont = False
    TabOrder = 15
    OnDblClick = edtVend2DblClick
    OnEnter = edtmaskeditformulario1Enter
    OnExit = edtVend2Exit
    OnKeyDown = edtVend2KeyDown
    zNomeOO = 'Vendedor final'
    zFieldTypeOO = ftInteger
    zFieldLengthOO = 6
    zTipoOO = -1
    zEntidadeOO = 'VENDEDORES'
    zLabelEntidadeOO = 'vendedores'
    zPainelEntidadeOO = PnVendedor2
    zTipoPesquisaF8 = True
    zMensagemF1 = 
      'C'#243'digo final do vendedor: formato 999999 - <F8/Duplo clique exib' +
      'e fornecedores cadastrados>'
  end
  object chVend: TCheckBoxOO [53]
    Left = 437
    Top = 347
    Width = 57
    Height = 17
    ...
    TabOrder = 40
    OnClick = chVendClick
    OnKeyDown = chVendKeyDown
    zEdit1MarcaOO = edtVend1
    zEdit2MarcaOO = edtVend2
    zEditFocusOO = edtQtde
  end
  object PnSubGrupo1: TPanelOO [54]
    Left = 68
    Top = 173
    Width = 156
    Height = 21
  ...
  object PnSubgrupo2: TPanelOO [55]
    Left = 282
    Top = 173
    Width = 149
    Height = 21
  ...
  object PnVendedor1: TPanelOO [56]
    Left = 68
    Top = 346
    Width = 156
    Height = 21
  ...
  object PnVendedor2: TPanelOO [57]
    Left = 282
    Top = 346
    Width = 149
    Height = 21
