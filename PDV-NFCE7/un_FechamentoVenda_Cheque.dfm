object frm_FechamentoVenda_Cheque: Tfrm_FechamentoVenda_Cheque
  Left = 52
  Top = 67
  ...
  object chFlag: TCheckBox
    ...
    Height = 17
    Cursor = crHandPoint
    Caption = 'Cheque do pr'#243'prio cliente'
    Checked = True
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clYellow
    Font.Height = -16
