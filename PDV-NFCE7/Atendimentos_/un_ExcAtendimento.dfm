object frm_ExcAtendimento: Tfrm_ExcAtendimento
  Left = 11
  Top = 50
  ...
  object Panel2: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 357
      Height = 16
      Caption = 'Selecione o item para exclus'#227'o e tecle ENTER ou DELETE'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -13
      Font.Name = 'Tahoma'
  ...
  object qItens: TQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM ITENS_ATDO_LOCAL'
      'WHERE (IA_LOJA=:loja) AND'
      '      (IA_CAIX=:caixa) AND'
      '      (IA_VEND=:codigo_venda)'
      ' '
      ' ')
    Left = 6
    Top = 72
    ...
    object qItensnomeProduto: TStringField
      FieldKind = fkCalculated
      FieldName = 'nomeProduto'
      Size = 70
      Calculated = True
    end
    object qItenscTota: TStringField
      FieldKind = fkCalculated
      FieldName = 'cTota'
      Calculated = True
    end
    object qItenscPven: TStringField
      FieldKind = fkCalculated
      FieldName = 'cPven'
      Calculated = True
    end
    object qItenscREFI: TStringField
      FieldKind = fkCalculated
      FieldName = 'cREFI'
      Calculated = True
    end
    object qItenscREFF: TStringField
      FieldKind = fkCalculated
      FieldName = 'cREFF'
      Calculated = True
    end
    object qItenscMODO: TStringField
      FieldKind = fkCalculated
      FieldName = 'cMODO'
      Calculated = True
    end
    object qItenscIA_CORE: TStringField
      FieldKind = fkCalculated
      FieldName = 'cIA_CORE'
      Calculated = True
    end
    object qItenscIA_TAMA: TStringField
      FieldKind = fkCalculated
      FieldName = 'cIA_TAMA'
      Calculated = True
    end
    object qItensIA_LOJA: TFloatField
      FieldName = 'IA_LOJA'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_LOJA'
    end
    object qItensIA_CAIX: TFloatField
      FieldName = 'IA_CAIX'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_CAIX'
    end
    object qItensIA_VEND: TFloatField
      FieldName = 'IA_VEND'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_VEND'
    end
    object qItensIA_GRUP: TFloatField
      FieldName = 'IA_GRUP'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_GRUP'
    end
    object qItensIA_SUBG: TFloatField
      FieldName = 'IA_SUBG'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_SUBG'
    end
    object qItensIA_PROD: TFloatField
      FieldName = 'IA_PROD'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_PROD'
    end
    object qItensIA_TAMA: TStringField
      FieldName = 'IA_TAMA'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_TAMA'
      Size = 5
    end
    object qItensIA_QTDE: TFloatField
      FieldName = 'IA_QTDE'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_QTDE'
    end
    object qItensIA_CORE: TFloatField
      FieldName = 'IA_CORE'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_CORE'
    end
    object qItensIA_TOTA: TFloatField
      FieldName = 'IA_TOTA'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_TOTA'
    end
    object qItensIA_PVEN: TFloatField
      FieldName = 'IA_PVEN'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_PVEN'
    end
    object qItensIA_OTAM: TSmallintField
      FieldName = 'IA_OTAM'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_OTAM'
    end
    object qItensIA_MODO: TSmallintField
      FieldName = 'IA_MODO'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_MODO'
    end
    object qItensIA_SEQ: TSmallintField
      FieldName = 'IA_SEQ'
      Origin = 'VENDAS.ITENS_ATDO_LOCAL.IA_SEQ'
    end
  end
end
