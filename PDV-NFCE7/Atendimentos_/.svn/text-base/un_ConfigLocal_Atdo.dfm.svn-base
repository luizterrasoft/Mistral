object frm_ConfigLocal_Atdo: Tfrm_ConfigLocal_Atdo
  Left = 131
  Top = 33
  ...
  object fichario: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object rdF8Cli: TRadioGroup
        ...
        Height = 62
        Cursor = crHandPoint
        Caption = ' Forma de Consulta do Cliente (F8) '
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -12
        Font.Name = 'Tahoma'
      ...
      object GroupBox2: TGroupBox
        ...
        Width = 473
        Height = 194
        Caption = ' Forma de Leitura Padr'#227'o do C'#243'digo de Barras do Item '
        TabOrder = 1
      ...
      object chPrevalecerEAN13: TCheckBoxOO
        ...
        Height = 17
        Cursor = crHandPoint
        Caption = 'Prevalecer o C'#243'digo EAN13 nos Lan'#231'amentos de Item de Produto'
    ...
    object pagina8: TTabSheet
      ...
      object Label26: TLabel
        ...
        Width = 312
        Height = 16
        Caption = 'Arquivo Execut'#225'vel do Word (todas as vers'#245'es)'
      end
      ...
      object edtWinWord: TEdit
        ...
        ParentFont = False
        TabOrder = 0
        Text = 'C:\Arquivos de programas\Microsoft Office\Office10\Winword.exe'
    ...
    object pagina9: TTabSheet
      ...
      object rdVideoEntrada: TRadioGroup
        ...
        Height = 68
        Cursor = crHandPoint
        Caption = 'Resolu'#231#227'o de V'#237'deo na Entrada no Sistema'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object rdVideoSaida: TRadioGroup
        ...
        Height = 68
        Cursor = crHandPoint
        Caption = 'Resolu'#231#227'o de V'#237'deo na Sa'#237'da do Sistema'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object chModificarVideo: TCheckBox
        ...
        Height = 17
        Cursor = crHandPoint
        Caption = 'Modificar Resolu'#231#227'o de V'#237'deo durante a Execu'#231#227'o do Sistema'
        TabOrder = 4
      end
    end
    object TabSheet2: TTabSheet
      ...
      object LabelOO1: TLabelOO
        ...
        Width = 323
        Height = 16
        Caption = 'Qtde. de linhas entre os SLIPS de Atendimento'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
      ...
      object edtQtdeLinhas_ATENDIMENTO: TMaskEditOO
        Left = 18
        Top = 107
        Width = 46
        Height = 21
        ...
        TabOrder = 0
        Text = '05'
        OnEnter = edtQtdeLinhas_ATENDIMENTOEnter
        OnKeyDown = edtQtdeLinhas_ATENDIMENTOKeyDown
        zFieldTypeOO = ftInteger
        zFieldLengthOO = 2
        zTipoOO = -1
        zTipoPesquisaF8 = False
      end
      object chSlipNaTela_ATENDIMENTO: TCheckBox
        Left = 27
        Top = 312
        Width = 382
        Height = 17
        Cursor = crHandPoint
        Caption = 'Exibir SLIP de Atendimento na Tela antes da Impress'#227'o '
        TabOrder = 1
        Visible = False
      end
      object rdRelatorio: TRadioGroup
        ...
        Height = 70
        Cursor = crHandPoint
        Caption = ' Op'#231#245'es de Relat'#243'rio de Atendimento: '
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  object Panel1: TPanel
    ...
    object Label12: TLabel
      ...
      Width = 222
      Height = 18
      Caption = '[Outras configura'#231#245'es locais]'
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -15
      Font.Name = 'Tahoma'
