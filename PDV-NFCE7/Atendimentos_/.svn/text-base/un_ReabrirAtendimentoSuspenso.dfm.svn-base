object frm_ReabrirAtendimentoSuspenso: Tfrm_ReabrirAtendimentoSuspenso
  Left = 197
  Top = 136
  ...
  object LabelOO2: TLabelOO
    ...
    Width = 188
    Height = 13
    Caption = '[ENTER] Selecionar atendimento'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object grade: TDBGrid
    ...
    Height = 150
    Cursor = crHandPoint
    Hint = 'ENTER / Duplo clique para selecionar o Atendimento pretendido'
    DataSource = ds1
  ...
  object qAtendimentos: TQuery
    ...
    SQL.Strings = (
      'SELECT * '
      'FROM ATENDIMENTOS_SUSP'
      'WHERE (AT_STAT='#39'3'#39') AND '
      '               (AT_LOJA=:loja) AND'
      '               (AT_VEND=:vendedor) AND'
      '               (AT_DATA=:data)')
    Left = 41
    Top = 103
    ParamData = <
    ...
    object qAtendimentosAT_CAIX: TFloatField
      FieldName = 'AT_CAIX'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_CAIX'
      DisplayFormat = '00'
    end
    object qAtendimentosAT_LOJA: TFloatField
      FieldName = 'AT_LOJA'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_LOJA'
    end
    object qAtendimentosAT_CODI: TFloatField
      FieldName = 'AT_CODI'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_CODI'
    end
    object qAtendimentosAT_FUNC: TFloatField
      FieldName = 'AT_FUNC'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_FUNC'
    end
    object qAtendimentosAT_DATA: TDateTimeField
      FieldName = 'AT_DATA'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_DATA'
    end
    object qAtendimentosAT_TOTA: TFloatField
      FieldName = 'AT_TOTA'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_TOTA'
      DisplayFormat = '######0.00'
    end
    object qAtendimentosAT_QTDE: TFloatField
      FieldName = 'AT_QTDE'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_QTDE'
    end
    object qAtendimentosAT_VEND: TFloatField
      FieldName = 'AT_VEND'
      Origin = 'ESTOQUE.ATENDIMENTOS.AT_VEND'
    end
  end
end
