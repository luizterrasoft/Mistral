...
procedure Tfrm_F8FormaPgto.botao_sairClick(Sender: TObject);
begin
  close;
end;

procedure Tfrm_F8FormaPgto.FormActivate(Sender: TObject);
begin
...
procedure Tfrm_F8FormaPgto.gradeDblClick(Sender: TObject);
begin
  ...
  frm_F8FormaPgto.close;
end;

procedure Tfrm_F8FormaPgto.gradeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrm_F8FormaPgto.gradeDrawColumnCell(Sender: TObject;
