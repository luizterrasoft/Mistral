object frm_ConfigLocal: Tfrm_ConfigLocal
  ...
  object fichario: TPageControl
      ...
      object PageControl1: TPageControl
        ...
        object TabSheet3: TTabSheet
          ...
          object chSaltoNat: TCheckBox
            ...
            Width = 265
            Height = 17
            Caption = 'Salto de página no final da impressão'
            TabOrder = 1
          end
        end
    ...
    object pagina6: TTabSheet
      ...
      object CheckBox1: TCheckBox
        ...
        Width = 457
        Height = 17
        Caption = 'Habilitar modo fiscal'
        TabOrder = 0
      end
      object listaModeloImpressoraFiscal: TListBox
        Left = 24
        Top = 59
        Width = 297
        Height = 81
      ...
      object btnConfigImpressoraFiscal: TPanel
        Left = 24
        Top = 147
        Width = 241
        Height = 22
        ...
        Caption = 'Configurar impressora fiscal'
        Color = clTeal
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -13
        ...
        ParentFont = False
        TabOrder = 2
        OnClick = btnConfigImpressoraFiscalClick
      end
    end
    object pagina7: TTabSheet
      ...
      object Label27: TLabel
        ...
        Width = 306
        Height = 16
        Caption = 'Endereço de e-mail da loja publicadora (matriz)'
      end
      ...
      object rdTipoExp: TRadioGroup
        ...
        Width = 316
        Height = 53
        Caption = 'Envio/recepção do movimento'
        Items.Strings = (
          'Via email (Outlook, MSN Messenger, etc...)'
          'Via FTP configurável')
        TabOrder = 2
      end
      object GroupBox1: TGroupBox
        ...
        object Label30: TLabel
          ...
          Width = 163
          Height = 16
          Caption = 'Nome do Usuário (userid)'
        end
    ...
    object pagina8: TTabSheet
      ...
      object Label26: TLabel
        ...
        Width = 305
        Height = 16
        Caption = 'Arquivo executável do word (qualquer versão)'
      end
      ...
      object Label28: TLabel
        ...
        Width = 297
        Height = 16
        Caption = 'Diretório dos programas utilitários do sistema'
      end
      object Label25: TLabel
        ...
        Width = 265
        Height = 16
        Caption = 'Arquivo de verso de proposta de crédito'
      end
      ...
      object Label17: TLabel
        ...
        Width = 396
        Height = 16
        Caption = 'Diretório dos arquivos de imagens (adicione uma "\" no final)'
      end
    ...
    object pagina9: TTabSheet
      ...
      object rdVideoEntrada: TRadioGroup
        ...
        Height = 68
        Cursor = crHandPoint
        Caption = 'Resolução de video na entrada no sistema'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object rdVideoSaida: TRadioGroup
        ...
        Height = 68
        Cursor = crHandPoint
        Caption = 'Resolução de video na saída do sistema'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object chModificarVideo: TCheckBox
        ...
        Width = 457
        Height = 17
        Caption = 'Modificar resolução de video durante a execução do sistema'
        TabOrder = 4
      end
    end
  end
  object Panel1: TPanel
    ...
    object Label12: TLabel
      ...
      Width = 222
      Height = 18
      Caption = '[Outras configurações locais]'
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -15
      Font.Name = 'Tahoma'
