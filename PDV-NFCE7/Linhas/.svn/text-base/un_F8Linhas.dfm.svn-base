inherited frm_F8Linhas: Tfrm_F8Linhas
  Caption = ''
  ClientHeight = 456
  OldCreateOrder = True
  OnCreate = FormCreate
  ...
  inherited Panel2: TPanel
    Top = 379
    BevelOuter = bvNone
    Caption = '  ENTER -> Selecionar a ?'
    Color = clTeal
  end
  inherited Panel3: TPanel
    Top = 409
    Color = clTeal
    inherited btn_procurar: TBitBtn
      Left = 160
      Top = 34
      Visible = False
    end
