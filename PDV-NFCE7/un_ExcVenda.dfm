object frm_ExcVenda: Tfrm_ExcVenda
  Left = 11
  Top = 50
  ...
  object qItens: TQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM ITENS_VENDAS_LOCAL'
      'WHERE (IV_LOJA=:loja) AND'
      '      (IV_CAIX=:caixa) AND'
      '      (IV_VEND=:codigo_venda)'
      ' ')
    Left = 690
    Top = 72
    ParamData = <
    ...
    object qItensIV_LOJA: TFloatField
      FieldName = 'IV_LOJA'
      Origin = 'CAIXA.ITENS_VENDAS.IV_LOJA'
    end
    object qItensIV_CAIX: TFloatField
      FieldName = 'IV_CAIX'
      Origin = 'CAIXA.ITENS_VENDAS.IV_CAIX'
    end
    object qItensIV_VEND: TFloatField
      FieldName = 'IV_VEND'
      Origin = 'CAIXA.ITENS_VENDAS.IV_VEND'
    end
    object qItensIV_TIPZ: TStringField
      FieldName = 'IV_TIPZ'
      Origin = 'CAIXA.ITENS_VENDAS.IV_TIPZ'
      Size = 1
    end
    object qItensIV_GRUP: TFloatField
      FieldName = 'IV_GRUP'
      Origin = 'CAIXA.ITENS_VENDAS.IV_GRUP'
    end
    object qItensIV_SUBG: TFloatField
      FieldName = 'IV_SUBG'
      Origin = 'CAIXA.ITENS_VENDAS.IV_SUBG'
    end
    object qItensIV_PROD: TFloatField
      FieldName = 'IV_PROD'
      Origin = 'CAIXA.ITENS_VENDAS.IV_PROD'
    end
    object qItensIV_TAMA: TStringField
      FieldName = 'IV_TAMA'
      Origin = 'CAIXA.ITENS_VENDAS.IV_TAMA'
      Size = 5
    end
    object qItensIV_CORE: TFloatField
      FieldName = 'IV_CORE'
      Origin = 'CAIXA.ITENS_VENDAS.IV_CORE'
    end
    object qItensIV_QTDE: TFloatField
      FieldName = 'IV_QTDE'
      Origin = 'CAIXA.ITENS_VENDAS.IV_QTDE'
    end
    object qItensIV_TOTA: TFloatField
      FieldName = 'IV_TOTA'
      Origin = 'CAIXA.ITENS_VENDAS.IV_TOTA'
    end
    object qItensIV_PVEN: TFloatField
      FieldName = 'IV_PVEN'
    ...
    object qItensIV_MODO: TSmallintField
      FieldName = 'IV_MODO'
      Origin = 'CAIXA.ITENS_VENDAS_LOCAL.IV_MODO'
    end
    object qItenscIV_CORE: TStringField
      FieldKind = fkCalculated
      FieldName = 'cIV_CORE'
      Calculated = True
    end
    object qItenscIV_TAMA: TStringField
      FieldKind = fkCalculated
      FieldName = 'cIV_TAMA'
      Calculated = True
    end
