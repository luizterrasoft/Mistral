    ...
    if (trim(edtDocumento.GetValor)<>'') and
      ...
      begin
        ...
        grade.setfocus;
                   ...
                   begin
                        frmDialogo.ExibirMensagem (' A transferência em questão não é destinada a esta loja! '
                             ,'Transferências',[mbOK]
                             ,frm_principal.x_pathimg+'iconeerro.bmp',250,200);
                        Limparformulrio1.click;
                        edtLojaOrigem.setfocus;
    ...
    if (tbltransf.active) then
      if (tbltransf.recordcount<>0) then
        ...
        begin
          ...
          if (frmDialogo.ExibirMensagem ('Confirma salvamento da Transferência?'
            ,'Vendas',[mbYes,mbNo],
          ...
          begin
            ...
            clTransf.ClearSql;
            clTransf.AddParam ('SELECT TR_NUME FROM TRANSF_LOJA                ');
