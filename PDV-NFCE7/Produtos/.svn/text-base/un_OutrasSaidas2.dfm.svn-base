object frm_OutrasSaidas2: Tfrm_OutrasSaidas2
  Left = 41
  Top = 36
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Vale mercadoria funcionário'
  ClientHeight = 449
  ClientWidth = 713
  Color = clTeal
  ...
  object Panel3: TPanel
    ...
    object botao1: TPanel
      ...
      Cursor = crHandPoint
      BevelInner = bvLowered
      Caption = 'Processar lote de saídas (F5)'
      Color = clTeal
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -13
  ...
  object Panel5: TPanel
    ...
    Height = 23
    Align = alBottom
    Caption = 'Lote de produtos lançados '
    Color = clTeal
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -13
  ...
  object Panel1: TPanel
    ...
    object edtPVenda: TMaskEdit
      ...
      ReadOnly = True
      TabOrder = 1
      OnEnter = edtPVendaEnter
      OnExit = edtPVendaExit
      OnKeyDown = edtPVendaKeyDown
      OnKeyUp = edtPVendaKeyUp
    end
    ...
    object edtPercDesc: TMaskEdit
      ...
      ParentFont = False
      TabOrder = 3
      OnEnter = edtPercDescEnter
      OnExit = edtPercDescExit
      OnKeyDown = edtPercDescKeyDown
      OnKeyUp = edtPercDescKeyUp
    end
    object edtValorDesc: TMaskEdit
      Left = 179
      Top = 19
      Width = 79
      Height = 21
  ...
  object MainMenu1: TMainMenu
    ...
    object Principal1: TMenuItem
      ...
      object Processarentradas1: TMenuItem
        Caption = 'Salvar vale mercadoria'
        ShortCut = 116
  ...
  object tblSaidas: TTable
    OnCalcFields = tblSaidasCalcFields
    DatabaseName = 'C:\NATIVA\VENDAS'
    Filtered = True
    TableName = 'TEMP_SAIDAS'
    TableType = ttDBase
    Left = 34
    Top = 176
    object tblSaidasGRUPO: TSmallintField
      FieldName = 'GRUPO'
    end
    object tblSaidasSUBGRUPO: TSmallintField
      FieldName = 'SUBGRUPO'
    end
    object tblSaidasPRODUTO: TFloatField
      FieldName = 'PRODUTO'
    end
    object tblSaidasLOJA: TSmallintField
      FieldName = 'LOJA'
    end
    object tblSaidasCOR: TSmallintField
      FieldName = 'COR'
    end
    object tblSaidasTAMANHO: TStringField
      FieldName = 'TAMANHO'
      Size = 5
    end
    object tblSaidasDATA: TDateField
      FieldName = 'DATA'
    end
    object tblSaidasMODE: TStringField
      FieldName = 'MODE'
      Size = 1
    end
    object tblSaidascTam: TStringField
      FieldKind = fkCalculated
      FieldName = 'cTam'
      Size = 10
      Calculated = True
    end
    object tblSaidascCor: TStringField
      FieldKind = fkCalculated
      FieldName = 'cCor'
      Size = 10
      Calculated = True
    end
    object tblSaidascPVenda1: TStringField
      FieldKind = fkCalculated
      FieldName = 'cPVenda1'
      Calculated = True
    end
    object tblSaidascTotal1: TStringField
      FieldKind = fkCalculated
      FieldName = 'cTotal1'
      Calculated = True
    end
    object tblSaidasQTDE: TFloatField
      FieldName = 'QTDE'
    end
    object tblSaidasTIPZ: TStringField
      FieldName = 'TIPZ'
      Size = 1
    end
    object tblSaidasPVENDA: TFloatField
      FieldName = 'PVENDA'
    end
    object tblSaidasSALDOANT: TIntegerField
      FieldName = 'SALDOANT'
    end
    object tblSaidasTOTAL: TFloatField
      FieldName = 'TOTAL'
    end
    object tblSaidascREFI: TStringField
      FieldKind = fkCalculated
      FieldName = 'cREFI'
      Calculated = True
    end
    object tblSaidascDescricao: TStringField
      DisplayWidth = 40
      FieldKind = fkCalculated
      FieldName = 'cDescricao'
      Size = 40
    ...
    object tblSaidascGrupo: TStringField
      FieldKind = fkCalculated
      FieldName = 'cGrupo'
      Calculated = True
    end
    object tblSaidascSubgrupo: TStringField
      FieldKind = fkCalculated
      FieldName = 'cSubgrupo'
      Calculated = True
    end
    object tblSaidascCodigo: TStringField
      FieldKind = fkCalculated
      FieldName = 'cCodigo'
      Calculated = True
    end
    object tblSaidascREFF: TStringField
      FieldKind = fkCalculated
      FieldName = 'cREFF'
      Calculated = True
    end
    object tblSaidascSaldo1: TStringField
      FieldKind = fkCalculated
      FieldName = 'cSaldo1'
      Calculated = True
    end
