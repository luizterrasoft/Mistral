inherited frm_PromocoesAVencer: Tfrm_PromocoesAVencer
  Left = 189
  Top = 163
  ActiveControl = edtDiasAVencer
  BorderStyle = bsNone
  Caption = 'Promo'#231#245'es a vencer'
  ClientHeight = 185
  ClientWidth = 417
  OnClose = FormClose
  PixelsPerInch = 96
  ...
  object edtDiasAVencer: TMaskEditOO [13]
    Left = 125
    Top = 58
    Width = 68
    Height = 21
    ...
    ParentFont = False
    TabOrder = 6
    OnEnter = edtDiasAVencerEnter
    OnKeyDown = edtDiasAVencerKeyDown
  ...
  object Panel1: TPanel [14]
    ...
    Caption = 'Listar Promo'#231#245'es - [F5]'
    Color = clTeal
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -13
  ...
  object chExibirCorTamanho: TCheckBox [15]
    Left = 19
    Top = 88
    Width = 140
    Height = 17
    Cursor = crHandPoint
    Caption = 'Exibir COR / TAMANHO'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  inherited MainMenu1: TMainMenu
    ...
    inherited Principal1: TMenuItem
      ...
      inherited N1: TMenuItem
        Caption = 'Listar promo'#231#245'es a vencer'
        ShortCut = 116
        OnClick = N1Click
      end
    end
