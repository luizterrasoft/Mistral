...
begin
  ...
  Writeln(arq,Tipo                                                    +Separador+
              ...
              Trim(AnsiReplaceStr(form_nc(valorAcrescimo,9),'.',''))  +Separador+
...
function TVendaNfe_Registro21.getvalorAcrescimo: Real;
begin
  Result := _valoracrescimo;
end;
...
procedure TVendaNfe_Registro21.setvalorAcrescimo(const Value: Real);
begin
