...
begin
  ...
  begin
    if (ModoOperando='SAIDA') then
      caption := 'Lançamento de itens para transferência - SAIDAS'
    else
    if (ModoOperando='ENTRADA') then
      caption := 'Lançamento de itens para transferência - ENTRADAS';
          {********************************************************************************}
    ...
    begin
      ...
      begin
        ...
        begin
                        {************************************************************}
          tblTransf.disablecontrols;
          mostra_mensagem('Processando transferência...Aguarde!');
