object frm_MudarOp: Tfrm_MudarOp
  Left = 143
  Top = 125
  ...
  object Label12: TLabel
    ...
    Width = 333
    Height = 18
    Caption = '[Configuração do operador de frente de loja]'
  ...
  object edtOp2: TMaskEdit
    ...
    TabOrder = 3
    Text = '    '
    OnDblClick = edtOp2DblClick
    OnEnter = edtOp2Enter
    OnKeyDown = edtOp2KeyDown
  end
  object pnOp2: TPanel
    Left = 89
    Top = 120
