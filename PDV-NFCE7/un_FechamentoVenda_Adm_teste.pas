unit un_FechamentoVenda_Adm_teste;
...
type
  Tfrm_FechamentoVenda_Adm_teste = class(TForm)
    MainMenu1: TMainMenu;
...
var
  frm_FechamentoVenda_Adm_teste: Tfrm_FechamentoVenda_Adm_teste;
...
procedure Tfrm_FechamentoVenda_Adm_teste.SAIR1Click(Sender: TObject);
begin
  close;
end;

procedure Tfrm_FechamentoVenda_Adm_teste.FormActivate(Sender: TObject);
var
  hR : THandle;
begin
...
procedure Tfrm_FechamentoVenda_Adm_teste.FocusControle(controle: TWinControl; direcao: Boolean);
var
  Lista: TList;
...
procedure Tfrm_FechamentoVenda_Adm_teste.botao1Click(Sender: TObject);
begin
  Confirmardados1.click;
end;

procedure Tfrm_FechamentoVenda_Adm_teste.botaoSairClick(Sender: TObject);
begin
  close;
end;

procedure Tfrm_FechamentoVenda_Adm_teste.FormCreate(Sender: TObject);
begin
  tecla:=27;
  jaChamou:=false;
end;

procedure Tfrm_FechamentoVenda_Adm_teste.Confirmardados1Click(Sender: TObject);
var
...
procedure Tfrm_FechamentoVenda_Adm_teste.Limparformulrio1Click(
  Sender: TObject);
begin
  LimparEdits;
  edtCodAdm.setfocus;
...
procedure Tfrm_FechamentoVenda_Adm_teste.LimparEdits;
var
  Lista: TList;
  ind: Integer;
begin
...
procedure Tfrm_FechamentoVenda_Adm_teste.FormKeyDown(Sender: TObject;
...
procedure Tfrm_FechamentoVenda_Adm_teste.edtCodAdmDblClick(Sender: TObject);
begin
  with (frm_f8Adm) do
  begin
    left:=287;
...
procedure Tfrm_FechamentoVenda_Adm_teste.edtCodAdmEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_FechamentoVenda_Adm_teste.edtCodAdmExit(Sender: TObject);
var
  codigo: String;
begin
...
procedure Tfrm_FechamentoVenda_Adm_teste.edtCodAdmKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure Tfrm_FechamentoVenda_Adm_teste.edtCartaoEnter(Sender: TObject);
begin
  TMaskEdit(sender).selectall;
end;

procedure Tfrm_FechamentoVenda_Adm_teste.edtCartaoKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (key=K_ENTER) then
    Confirmardados1.click;
...
function Tfrm_FechamentoVenda_Adm_teste.IsAdmDebitoAut(codigo: Real):Boolean;
var
