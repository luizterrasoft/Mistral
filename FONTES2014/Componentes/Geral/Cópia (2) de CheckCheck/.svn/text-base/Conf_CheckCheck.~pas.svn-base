...
begin
   ...
   with query2 do begin
    sql.clear;
    sql.add('Select Ck_Pos,Ck_Consulta,Ck_Valor,Ck_FaixaIni,Ck_Tempo,Ck_cliente,Ck_Senha,Ck_Serial,ck_bloq,ck_senhaM From CheckCheck');
    ...
    for i2:=gridCOns.ColunaCampo('Ck_Tempo') + 1 to GridCons.ColCount - 1 do
...
begin
     ...
     try
       ...
       query1.sql.clear;
       query1.sql.add('Insert Into CheckCheck (Ck_Pos,Ck_Consulta,Ck_Valor,Ck_FaixaIni,Ck_Tempo,Ck_cliente,Ck_Senha,Ck_Serial,ck_bloq,ck_senhaM)');
       query1.sql.add('Values (:Ck_Pos,:Ck_Consulta,:Ck_Valor,:Ck_FaixaIni,:Ck_Tempo,:Ck_cliente,:Ck_Senha,:Ck_Serial,:ck_bloq,:ck_senhaM)');
...
//            Query1.ParamByName('Ck_SenhaM').AsString := SenhaM.text;
            for i2:=0 to gridCons.ColunaCampo('Ck_Tempo') do
