...
procedure TFormCupomFiscal.Button8Click(Sender: TObject);
begin

end;

procedure TFormCupomFiscal.Button9Click(Sender: TObject);
begin

end;

procedure TFormCupomFiscal.Button10Click(Sender: TObject);
begin

end;

procedure TFormCupomFiscal.Button12Click(Sender: TObject);
begin
