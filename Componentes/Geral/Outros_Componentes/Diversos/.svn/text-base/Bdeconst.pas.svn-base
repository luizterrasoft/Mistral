...
resourcestring
  ...
  STableMismatch = 'Tabelas fonte e destino são imcompatíveis';
  SFieldAssignError = 'Campos ''%s'' e ''%s'' não são compatíveis para atribuição';
  SNoReferenceTableName = 'Referencia do nome da tabela não especificado para o campo ''%s''';
  ...
  STruncationError = 'Parâmetro ''%s'' truncado na saida';
  ...
  SNoProvider = 'Não há Provider disponível';
