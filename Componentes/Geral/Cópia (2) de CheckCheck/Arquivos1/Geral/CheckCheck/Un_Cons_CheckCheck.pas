...
uses
  ...
  Dialogs, Mask, MaskEdit, StdCtrls, EditControle, PiscaLabel, ExtCtrls,
  ComCtrls, Grids, GridControl, GridSql, MemoControle, DB, DBTables,CHECKCOMLib_TLB,bitbtncontrole,buttons,funcoesglobais,maskutils;
...
implementation
uses Principal, unDialogo, unMensagem,funcoes2, Un_Senha_CheckCheck;
    ...
    with Frm_ConsCheckCheck do begin
     ...
     //Abrindo conexao
      ...
      begin
        ...
        begin
          frm_mensagem.pn_mensagem.caption := 'Realizando Operção de Login com a Check Check';
          frm_mensagem.painel.visible:=true;
